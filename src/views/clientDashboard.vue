    ...
    <div class="flex flex-col md:pl-64">
        ...
        <main class="flex-1">
            <div class="py-6">
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                    <div class=" grid grid-rows-2 grid-cols-4  bg-yellow-500 dark:bg-white gap-9 rounded-md justify-center">
                        <p class="m-1 p-3">1</p>
                        <p class="m-1 p-3">1</p>
                        <p class="m-1 p-3">1</p>
                        <p class="m-1 p-3">1</p>
                    ...
                    <div class="py-4">
                        <div class=" m-1 grid grid-rows-2 grid-cols-4  bg-yellow-500 dark:bg-white gap-9 rounded-md justify-center">
                            <p class=" m-1 p-3">1</p>
                            <p class=" m-1 p-3">1</p>
                            <p class=" m-1 p-3">1</p>
                            <p class=" m-1 p-3">1</p>
