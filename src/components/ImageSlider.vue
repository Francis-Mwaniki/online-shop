...
<div class=" flex justify-center items-center gap-5">
    <swiper class="p-1 mx-auto container bg-gray-300  dark:bg-slate-900 pl-10 py-10 mt-2" :modules="modules" :slides-per-view="3" :space-between="10" navigation :pagination="{ clickable: true }" :scrollbar="{ draggable: true }" @swiper="onSwiper" @slideChange="onSlideChange">
        <swiper-slide class=" mr-10">
           ...
           <p class=" flex justify-end overflow-hidden"><blockquote class="border-b font-medium italic border-orange-700 mx-auto">Co-Founder:digitalStore</blockquote></p>
            </div>
        </swiper-slide>
        <swiper-slide class="">
          ...
          <p class=" flex justify-end overflow-hidden"><blockquote class=" text-white border-b font-medium italic border-orange-700 mx-auto dark:text-gray-200">Co-Founder:digitalPro&trade;</blockquote></p>
            </div>
        </swiper-slide>
        <swiper-slide class=" ">
            ...
            <p class=" flex justify-end overflow-hidden"><blockquote class="dark:text-black text-white border-b font-medium italic border-orange-700 mx-auto">Co-Founder:Cosmas cheruiyot</blockquote></p>
            </div>
        </swiper-slide>
        <swiper-slide class="">
           ...
           <p class=" flex justify-end overflow-hidden"><blockquote class="dark:text-black text-white border-b font-medium italic border-orange-700 mx-auto">Co-Founder:Francis mwaniki</blockquote></p>
            </div>
        </swiper-slide>
        ...
        <swiper-slide class=" mx-auto">
           ...
           <p class=" flex justify-end overflow-hidden"><blockquote class="border-b font-medium italic border-orange-700 mx-auto">Co-Founder:E_TECH</blockquote></p>
            </div>
        </swiper-slide>
        ...
    </swiper>
