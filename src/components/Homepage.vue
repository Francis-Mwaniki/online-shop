...
<div class="mx-auto">
    ...
    <video src="@/assets/newEarth.mp4" loop="loop" autoplay="autoplay" playsinline muted="muted" class=" w-full absolute object-cover " style="top: -10px; height: 780px;"></video>
</div>
<div class="sm:pl-3 md:pl-9  pl-6 pr-28 md:pt-72 pt-2 max-w-7xl mx-auto">
...
<div class="flex border-red-900 border-l-2 bg-gradient-to-r from-slate-900 via-bookmark-blue to-orange-500  mt-3 p-3 bg-slate-900 dark:bg-slate-700 dark:hover:bg-orange-300 text-black justify-center text-center  flex-col-reverse md:flex-row md:justify-start">
    <div class=" p-2 m-2 max-w-2xl md:mt-36 mt-9 text-white">
        ...
        <button class=" ease-in duration-300 btn  bg-red-900 mt-6 hover:bg-bookmark-white hover:text-black">More info</button>
    </div>
