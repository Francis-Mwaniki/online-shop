...
<div class="
     flex
      ...
      justify-center
       ...
       border-b
       border-orange-600 
    " v-show="userSigned" @mouseover="dismiss">
    <p class=" pr-6">{{text}}</p>
    ...
    <form @submit.prevent="handleSubmit" class="
      ...
      ">
        ...
        <div class="m-5 flex-col md:flex-row md:mx-9">
            ...
            <input type="text" name="fname" required placeholder="FirstName" class="
            mt-3
            py-4
            pr-5
            pl-3
        ...
        <div class="m-5 flex-col md:flex-row md:mx-9">
            ...
            <input type="text" name="lname" required placeholder="LastName" class="
            mt-3
            py-4
            pr-5
            pl-3
        ...
        <div class="md:mx-9 m-5 flex-col md:flex-row">
            ...
            <input type="password" name="confirmPass" required placeholder="confirmPass" class="
            mt-3
            py-4
            pr-5
            pl-3
        ...
        <span class="flex items-center justify-center mt-2"> <button type="submit" :class="[
                reg_in_submission ? 'bg-gray-400 hover:bg-slate-400' : '',
              ]" :disabled="reg_in_submission" class="
        ...
        <div class=" flex md:flex-row mt-3 lg:flex-row flex-col justify-self-center md:justify-center mx-auto md:gap-y-1 gap-y-4 md:gap-x-3 flex-wrap md:flex-nowrap">
            <button class="flex justify-center gap-x-2 btn bg-bookmark-blue md:w-1/2 w-full text-bookmark-white bg-gradient-to-br from-pink-600 via-cyan-700 to-orange-500 hover:text-black">
        ...
        <div class="flex justify-self-center justify-center pt-5">
            <h3 class=" dark:text-white text-gray-400">Already have an account?</h3>
            <router-link :to="{name:'login'}" class="  underline dark:text-bookmark-white text-bookmark-red px-1">Login</router-link>
        </div>
    </div>
</section>
