<template>
<!-- REGISTERING USER -->
<div class=" container mx-auto w-auto md:max-w-3xl h-auto md:h-auto bg-gray-100 dark:bg-slate-700 shadow-black shadow-lg rounded-md border-x-2 border-orange-900 mb-2">
